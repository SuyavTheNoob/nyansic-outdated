        ...
        if (interaction.customId === 'voice_channel_options') {
          ...
          switch (value) {
            ...
            case 'make_private':
              ...
              interaction.reply({ content: 'Channel is now private.', ephemeral: true });
              break;
            ...
            case 'dont_delete_on_leave':
              ...
              interaction.reply({ content: 'Channel will not be deleted when the creator leaves.', ephemeral: true });
              break;

            case 'edit_channel_name':
              interaction.reply({ content: 'Please provide the new name for the channel:', ephemeral: true });
              ...
              if (collected) {
                ...
                interaction.followUp({ content: `Channel name changed to ${newName}.`, ephemeral: true });
              } else {
